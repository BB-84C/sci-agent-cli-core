...
```powershell
python -m pip install "https://github.com/BB-84C/sci-agent-cli-core/releases/download/<v_latest_release_ver>/sci_agent_cli_core-<v_latest_release_version>-py3-none-any.whl"
```
